...
Qwen3 synthesizes search results into a coherent response. Since Qwen3 runs at the edge (see [v0.9](./v0.9-nl-search-basic.md)), this requires a second round-trip: the client sends raw search results to the edge for summarization.
