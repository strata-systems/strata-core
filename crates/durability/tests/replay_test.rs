...
fn test_replay_multiple_committed_transactions() {
    ...
    for i in 1..=3u64 {
        ...
        assert_eq!(result.version, Version::Txn(i));
    }
}
...
fn test_replay_preserves_exact_versions() {
    ...
    let alpha = store
        ...
        .unwrap()
        .unwrap();
    assert_eq!(alpha.version, Version::Txn(1000)); // Not 1, but 1000!
    ...
    let beta = store
        ...
        .unwrap()
        .unwrap();
    assert_eq!(beta.version, Version::Txn(2000)); // Not 2, but 2000!
    ...
    let gamma = store
        ...
        .unwrap()
        .unwrap();
    assert_eq!(gamma.version, Version::Txn(3000)); // Not 3, but 3000!
...
fn test_replay_multiple_writes_same_key() {
    ...
    assert_eq!(result.version, Version::Txn(3));
}
...
fn test_replay_deterministic_order() {
    ...
    for _ in 0..3 {
        ...
        for i in 1..=5u64 {
            ...
            assert_eq!(vv.version, Version::Txn(i));
        }
    }
}
...
fn test_replay_twenty_sequential_transactions() {
    ...
    for i in 1..=NUM_TRANSACTIONS {
        ...
        assert_eq!(vv.version, Version::Txn(i), "key{} should have version {}", i, i);
    }
}
