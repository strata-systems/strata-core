...
| `V1Q-006` | Storage-next architecture, L2, core | Identifier and encoding ownership between core and storage. | `M1B`, `M1C`, `M3B` | Core atom encodings close in M1; storage object/path encodings close in M3B. | Milestone-owned. |
