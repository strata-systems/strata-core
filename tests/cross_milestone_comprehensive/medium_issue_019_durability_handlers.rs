...
fn test_in_memory_mode() {
    ...
    kv.put(&test_db.run_id, "inmem_key", strata_core::value::Value::Int(42))
        .expect("put");
...
fn test_buffered_mode() {
    ...
    kv.put(&test_db.run_id, "buffered_key", strata_core::value::Value::Int(42))
        .expect("put");
...
fn test_strict_mode() {
    ...
    {
        let kv = test_db.kv();
        kv.put(&run_id, "strict_key", strata_core::value::Value::Int(42))
            .expect("put");
    }
